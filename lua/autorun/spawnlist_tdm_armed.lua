...
list.Set( "simfphys_vehicles", "tdm_combineapc", V )
...
list.Set( "simfphys_vehicles", "tdm_hecuapc", V )
...
list.Set( "simfphys_vehicles", "tdm_bulldog", V )
...
list.Set( "simfphys_vehicles", "tdm_bulldog_mg", V )
...
list.Set( "simfphys_vehicles", "tdm_hmmvv", V )
...
list.Set( "simfphys_vehicles", "tdm_hmmvv_mg", V )
...
list.Set( "simfphys_lights", "tdm_lav", light_table)
...
list.Set( "simfphys_vehicles", "tdm_lav", V )
...
local V = {
	Name = "Bradley",
	Model = "models/simfphys/tdm/bradley.mdl",
	Class = "gmod_sent_vehicle_fphysics_base",
	Category = "TDM Rebalance",
...
list.Set( "simfphys_vehicles", "tdm_bradley", V )