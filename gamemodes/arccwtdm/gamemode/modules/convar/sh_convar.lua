...
CreateConVar("tdm_ff_vehicle", 0.25, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Friendly fire damage percent against friendly vehicles.", 0, 1)
...
CreateConVar("tdm_money_vehicle_damage", 0.05, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Reward per point of damage dealt to an enemy vehicle (rounded down).", 0)
CreateConVar("tdm_money_vehicle_kill", 1, FCVAR_ARCHIVE + FCVAR_REPLICATED, "Reward multiplier (of the point cost) for dealing the killing blow to an enemy vehicle.", 0)
